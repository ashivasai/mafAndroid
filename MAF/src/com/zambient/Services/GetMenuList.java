...
import com.zambient.maf.MenuListActivity;
 ...
 */
public class GetMenuList extends AsyncTask<String,String,String> {
    ProgressDialog pDialog;
    MenuListActivity activity;
    public GetMenuList(MenuListActivity activity) {
