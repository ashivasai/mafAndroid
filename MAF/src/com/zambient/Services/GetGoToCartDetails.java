 ...
 */
public class GetGoToCartDetails extends AsyncTask<String,String,String> {
    ProgressDialog pDialog;
    ProductsActivity activity;
    public GetGoToCartDetails(ProductsActivity activity) {
    ...
    protected void onPostExecute(String response) {
        ...
        if(Utils.isNotNull(response)){
           activity.serviceResponseGoToCart(response);
