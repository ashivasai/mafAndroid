...
private Context context;
    GridView doctorslistGrid;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.content_doctors_list);
      /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        doctorslistGrid = (GridView)findViewById(R.id.doctorslistGrid);
        context =this;
        SharedPreferences pref = getApplicationContext().getSharedPreferences("MyPref", MODE_PRIVATE);
        TextView mTitleTextView = (TextView) findViewById(R.id.title_text);
        mTitleTextView.setText("Our Doctors");
    ...
    private class GetDoctorsList extends AsyncTask<String,String,DoctorsListDto> {
        ...
        @Override
        protected DoctorsListDto doInBackground(String... params) {
            String data = null;
            try {
            ...
            return gson.fromJson(reader, DoctorsListDto.class);
        }

        @Override
        protected void onPostExecute(DoctorsListDto doctorsListDto) {
            super.onPostExecute(doctorsListDto);
            if (pDialog.isShowing())
                pDialog.dismiss();
            if(doctorsListDto!=null){
                DoctorsListAdapter  doctorsListAdapter= new DoctorsListAdapter(doctorsListDto,context);
                doctorslistGrid.setAdapter(doctorsListAdapter);
